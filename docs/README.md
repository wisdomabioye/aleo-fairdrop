...
| Directory | Contents |
|---|---|
| `architecture/` | Protocol design decisions, gap analysis, implementation status, frontend architecture |
| `contracts/` | Per-contract reference docs (invariants, struct field descriptions) |
