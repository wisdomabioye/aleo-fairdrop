...
`fairdrop_ascending_v4.aleo` only — other auction types do not have a "last-second" problem.
...
| Layer | Touch |
|---|---|
| Contract | `fairdrop_ascending_v4.aleo` — AscendingParams, AuctionState, place_bid_*, close_auction |
